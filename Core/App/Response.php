...
final class Response
{
    public static function html(string $title, string $body, Runtime $runtime, int $status = 200): void
    {
        ...
        $lockHtml = $lock['locked']
            ...
            : '';
        $nav = $user === null ? '' : '<nav><a href="?">ダッシュボード</a><a href="?action=new">作成</a><a href="?action=generate">静的生成</a><a href="?action=publish">公開</a><a href="?action=themes">テーマ</a><a href="?action=updates">アップデート</a><a href="?action=logout">ログアウト</a></nav>';
